(function(){
    var arr=[20180909,20180920,20180729,20181001]
    /*
       ...
       // console.log(tds)
        for(var i = 0; i < tds.length; i++) {
            for(var j=0;j<arr.length;j++){
                if(tds[i].getAttribute('data')==arr[j]){
                    tds[i].classList.add("active");
                    addEvent(tds[i], 'click', ss);    
                }else{
                    removeEvent(tds[i], 'click',function(e){})
                }
            }
        }
    }
